...
export const INDUSTRIES = {
  ...
  trades: {
    ...
    pitch: "Maak mijn demo — geen installatie nodig. Je test direct met je eigen gegevens.",
    perks: PERKS,
    personas: PERSONAS,
    ...
    scenarios: [
      { label: "Geen verwarming of warm water" },
      { label: "Ik heb een lekkage" },
      { label: "Een stop slaat steeds door" },
      { label: "Ik ruik gas" },
    ],
...
CLOSING: confirm what happens next (someone will call back, or an engineer is on the way), then end warmly.${DUTCH_LANGUAGE_DIRECTIVE}`,
  ...
  property: {
    ...
    scenarios: [
      { label: "Waterlekkage" },
      { label: "Geen verwarming" },
      { label: "Ik ben buitengesloten" },
      { label: "Iets urgents" },
    ],
...
CLOSING: confirm whether it's been escalated now or logged for the morning, then end warmly.${DUTCH_LANGUAGE_DIRECTIVE}`,
  ...
  vet: {
    ...
    scenarios: [
      { label: "Mijn hond loopt mank" },
      { label: "Een afspraak maken" },
      { label: "Ik heb meer medicatie nodig" },
      { label: "Mogelijk spoedgeval" },
    ],
...
CLOSING: confirm what happens next, thank them warmly, and end.${DUTCH_LANGUAGE_DIRECTIVE}`,
  ...
  clinic: {
    ...
    scenarios: [
      { label: "Tandheelkundig spoedgeval" },
      { label: "Een afspraak maken" },
      { label: "Herhaalrecept" },
      { label: "Urgente klacht" },
    ],
...
CLOSING: confirm whether it's booked, escalated, or a callback, then end warmly.${DUTCH_LANGUAGE_DIRECTIVE}`,
  ...
  msp: {
    id: "msp",
    label: "Horeca",
    emoji: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 3v6a2 2 0 0 0 2 2h2a2 2 0 0 0 2 -2v-6M8 3v19M16 3v19M16 3a5 5 0 0 0 -5 5v7h5"/></svg>',
    eyebrow: "Ontdek hoe een virtuele telefonische assistent werkt voor jouw organisatie",
    headline: "Maak in een paar minuten jouw telefonische assistent.",
    subheadline: "Vul je praktijkgegevens in, kies de functies en test de assistent zelf.",
    pitch: "Maak mijn demo — geen installatie nodig. Je test direct met je eigen gegevens.",
    ...
    scenarios: [
      ...
      { label: "Probleem met e-mail" },
      { label: "Iets ligt eruit" },
      { label: "Grote storing" },
    ],
...
CLOSING: confirm whether it's resolved, ticketed, or escalated, give the ticket reference if created, then end.${DUTCH_LANGUAGE_DIRECTIVE}`,
  ...
  utilities: {
    ...
    scenarios: [
      { label: "Stroomstoring" },
      { label: "Gaslucht" },
      { label: "Meterstand doorgeven" },
      { label: "Een storing melden" },
    ],
...
CLOSING: confirm whether it's escalated as a safety issue or logged, then end.${DUTCH_LANGUAGE_DIRECTIVE}`,
  ...
  hospitality: {
    ...
    scenarios: [
      { label: "Probleem met kamer" },
      { label: "Laat inchecken" },
      { label: "Een korte vraag" },
      { label: "Iets urgents" },
    ],
...
CLOSING: confirm what you've arranged or escalated, then wish them a good stay.${DUTCH_LANGUAGE_DIRECTIVE}`,
  ...
  contactcentre: {
    id: "contactcentre",
    label: "Haar & Schoonheid",
    emoji: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M6 7m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" /><path d="M6 17m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" /><path d="M20 6l-10.662 10.662" /><path d="M20 18l-10.662 -10.662" /></svg>',
    eyebrow: "Ontdek hoe een virtuele telefonische assistent werkt voor jouw organisatie",
    headline: "Maak in een paar minuten jouw telefonische assistent.",
    subheadline: "Vul je praktijkgegevens in, kies de functies en test de assistent zelf.",
    pitch: "Maak mijn demo — geen installatie nodig. Je test direct met je eigen gegevens.",
    ...
    scenarios: [
      { label: "Status bestelling" },
      { label: "Een veelgestelde vraag" },
      { label: "Terugbelverzoek plannen" },
      { label: "Met iemand spreken" },
    ],
